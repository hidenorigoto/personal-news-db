...
from .schemas import AIConfig, SummaryRequest, SummaryResponse, AIProviderType
...
class OpenAIProvider(AIProvider):
    ...
    def _build_prompt(self, request: SummaryRequest) -> str:
        ...
        # デフォルトプロンプトテンプレート
        templates = {
            "concise": "以下のニュース記事を{max_length}文字程度で簡潔に要約してください。重要なポイントのみを含めてください。\n\n記事:\n{content}",
            "detailed": "以下のニュース記事を{max_length}文字程度で詳細に要約してください。背景情報や詳細も含めて包括的にまとめてください。\n\n記事:\n{content}",
            "bullet_points": "以下のニュース記事の要点を箇条書きで{max_length}文字程度にまとめてください。\n\n記事:\n{content}",
            "executive": "以下のニュース記事をエグゼクティブサマリー形式で{max_length}文字程度にまとめてください。意思決定に必要な情報を中心に記載してください。\n\n記事:\n{content}"
        }
